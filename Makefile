...
test:
	javac -d bin -classpath bin/gui.jar -sourcepath src src/TestGUI.java src/TestBalls.java src/TestImmigration.java src/TestConway.java src/Conways.java src/TestBallsSimulator.java src/TestSchelling.java src/TestBoidsSimulator.java
